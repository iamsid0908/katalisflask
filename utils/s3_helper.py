...
class ObjectWrapper:
    ...
    def put(self, data):
        ...
        if isinstance(data, str):
            try:
                ...
                log.exception("Expected file name or binary data, got '%s'.", data)
                raise
    ...
    def list(bucket, prefix=None):
        ...
        try:
            ...
            log.exception("Couldn't get objects for bucket '%s'.", bucket.name)
            raise
        else:
            return objects
    ...
    def delete_objects(bucket, object_keys):
        ...
        try:
            ...
            log.exception("Couldn't delete any objects from bucket %s.", bucket.name)
            raise
        else:
            return response
    ...
    def empty_bucket(bucket):
        ...
        try:
            ...
            log.info("Emptied bucket '%s'.", bucket.name)
        except ClientError:
            log.exception("Couldn't empty bucket '%s'.", bucket.name)
            raise
    ...
    def put_acl(self, email):
        ...
        try:
            ...
            log.info("Granted read access to %s.", email)
        except ClientError:
            log.exception("Couldn't add ACL to object '%s'.", self.object.key)
            raise
    ...
    def get_acl(self):
        ...
        try:
            ...
            log.exception("Couldn't get ACL for object %s.", self.object.key)
            raise
        else:
            return acl
